...
//                            );
    ...
    private void displayChatMessages() {
        ...
        adapter = new FirebaseListAdapter<ChatMessage>(this, ChatMessage.class,
                R.layout.chatmessage, FirebaseDatabase.getInstance().getReference()) {
            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode,
        ...
        if (requestCode == SIGN_IN_REQUEST_CODE && resultCode == RESULT_OK) {
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(this,
                        "We couldn't sign you in. Please try again later." + requestCode + SIGN_IN_REQUEST_CODE + resultCode + RESULT_OK,
                        Toast.LENGTH_LONG)
                        .show();
